...
using SpaceEngineersCalculator.Desktop.Controls;
using SpaceEngineersCalculator.Desktop.Interfaces;
using SpaceEngineersCalculator.Desktop.Proxies;
...
namespace SpaceEngineersCalculator.Desktop.Extensions
{
	...
	public static class INotifyPropertyChangedExtensions
	{
		...
		public static async Task<bool> ConfirmAsync(this INotifyPropertyChangedEx source, string title, string message, string yesText = null, string noText = null)
		{
			...
			var result = await window.ShowMessageAsync(title, message, MessageDialogStyle.AffirmativeAndNegative, dialogSettings);
